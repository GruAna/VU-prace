...
In this section selected images with predictions and ground truth bounding boxes and labels are presented. Also I added comments on used method and achieved CER score.

The original image with ground truth displaeyd in Aletheia labeling tool is in Fig. \ref{Im1:orig}. 

In Fig. ref{Im1:ex:easytun} and ref{Im1:ex:easy} are results from both tuned and not tuned EasyOCR. Images are croppelmmm, because in the upper part of the picture is no text and results are then better comparable.

\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.46]{obrazky/plakaty/result_easyOCR_vienna1_split_tuning-91.png}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.46]{obrazky/plakaty/result_easyOCR_vienna1_nosplit_notuning-91.png}
    \caption{EasyOCR, no tuning.}
    \label{Im1:ex:easy}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.46]{obrazky/plakaty/result_kerasOCRtrained_vienna1_split-90.png}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.46]{obrazky/plakaty/result_kerasOCR_vienna1_nosplit_nocorrection-90.png}
    \caption{Keras-OCR}
    \label{Im1:ex:ker}
\end{figure}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.46]{obrazky/plakaty/result_carfttesseract_vienna1_split_special_snesitive-91.png}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[scale=0.46]{obrazky/plakaty/result_tesseract_vienna1_split_psm11-91.png}
