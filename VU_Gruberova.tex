...
\input{kapitoly/ocr.tex}

\input{kapitoly/nn.tex}
\input{kapitoly/software.tex}
% \input{kapitoly/datasets.tex}
\input{kapitoly/functions.tex}
\input{kapitoly/results.tex}
\input{kapitoly/conslusion.tex}
...
\input{kapitoly/examples.tex} % text vkládán ze souboru, kde je i příkaz \chapter{...}
